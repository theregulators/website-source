  ...
  render() {
    return (<div>
      ...
      <figure class='figure d-block p-3'>
        <img class='figure-img d-block m-auto rounded mw-100' src='/assets/app-screenshot.png' />
      ...
      <p>This method offers several benefits over the app from last year, which used a blind arithmetic average of colors in a rectangular region. With consistent changes in lighting, our app was accurate to ±30g/dL concentration.</p>
      <figure class='figure d-block p-3'>
        <img class='figure-img d-block m-auto rounded mw-100' src='/assets/app-demo.gif' />
